...
<div class="row">
    ...
    <div class="col-md-6">
        <form method="get">
            <select name="interval" id="" class="float-md-right" onChange="this.form.submit()">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corrupti aperiam reprehenderit provident reiciendis quia cum corporis est nulla impedit. Sint, ab consequatur doloremque architecto quia qui a minus provident quo.</p>
                </div>
            </div>
        </div>
    </div>
